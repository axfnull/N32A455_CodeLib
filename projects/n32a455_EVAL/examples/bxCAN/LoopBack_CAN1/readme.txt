...
CAN1: RX - PD0, TX - PD1, baud rate 500K, loopback test mode
     ...
     /* Describe the test steps and phenomena of the Demo */
         ...
         2. Check the serial port printing information, CAN1 regards the sent message as the received message and saves it, and the program runs normally when the printing information is viewed as received;
