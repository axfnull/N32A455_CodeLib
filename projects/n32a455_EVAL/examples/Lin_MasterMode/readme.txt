...
2、使用环境
    ...
    软件开发环境：KEIL MDK-ARM Professional Version 5.34.0.0
    硬件环境：全功能板N32A455VEL7_EVB V1.0
...
2. Use environment
    ...
    Software development environment: KEIL MDK-ARM Professional Version 5.34.0.0
    Hardware environment: full-function board N32A455VEL7_EVB V1.0
