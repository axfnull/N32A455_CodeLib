...
1. Function description
    1. ADC1 regularly samples PC2, automatically injects and samples the analog voltage of the PC3 pin, and triggers sampling under the TIM1 CC2 event
...
3. Instructions for use
    System Configuration;
        ...
        5. ADC:
            ADC1 independent working mode, TIM1 CC2 trigger, 12-bit data right-aligned, regular conversion channel PC2, automatic injection of analog voltage data of conversion channel PC3
        6. TIM:
