...
1. Function description
    1. The ADC1 regular channel samples the analog voltage of the PC2 and PC3 pins, and the injection channel samples the analog voltage of the PA0 and PA1 pins
...
3. Instructions for use
    System Configuration;
        ...
        3. Port configuration:
            ...
            PE11 is selected as external EXTI event rising edge trigger
            PE15 is selected as external EXTI event rising edge trigger
        4. DMA:
        ...
        5. ADC:
            ADC1 regular channel independent working mode, scan intermittent mode, EXTI11 trigger, 12-bit data right-justified, convert the analog voltage data of channels PC2 and PC3
            ADC1 injects channel independent working mode, scan mode, EXTI15 trigger, 12-bit data right-justified, and converts the analog voltage data of channels PA0 and PA1
    Instructions:
        ...
        2. The rising edge of PE11 can trigger regular channel data sampling, and the rising edge of PE15 can trigger the injection channel data sampling
