...
1. Function description
    1. ADC1 ADC2 regular channel synchronous sampling, ADC1 samples the analog voltage of PC2 and PC3 pins, ADC2 samples the analog voltage of PA4 and PA5 pins
...
3. Instructions for use
    System Configuration;
        ...
        2. Port configuration:
            ...
            PA4 is selected as analog function ADC2 conversion channel
        ...
        4. ADC:
            ADC1 regular channel synchronization regular channel mode, continuous scan mode, software trigger, 12-bit data right-justified, analog voltage data of conversion channels PC2 and PC3
            ADC2 regular channel synchronization regular channel mode, continuous scan mode, software trigger, 12-bit data right justification, conversion of analog voltage data of channels PA4 and PA5
    Instructions:
        1. Open the debug mode after compiling, and add the variable ADC_DualConvertedValueTab[16] to the watch window to observe
        2. Before running at full speed, PC2 PC3 PA4 PA5 gives the determined voltage signal, after running at full speed, the result can be converted 16 times to the ADC_DualConvertedValueTab[16] array
