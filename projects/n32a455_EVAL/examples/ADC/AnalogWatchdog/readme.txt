...
1. Function description
    1. ADC1 samples and converts the analog voltage of the PC2 pin. If it exceeds the threshold range defined by the analog watchdog, it will jump into the interrupt program
2. Use environment
...
3. Instructions for use
    System Configuration;
        1. Clock source:
            HSE=8M,PLL=144M,AHB=144M,APB1=36M,APB2=72M,ADC CLK=144M/16,ADC 1M CLK=HSE/8
        2. ADC:
            ADC1 independent working mode, continuous conversion, software trigger, 12-bit data right-justified, convert the analog voltage data of PC2 pin
        3. Port configuration:
            PC2 selected as analog function ADC1 conversion channel 8
        4. Interrupt:
            ADC1 analog watchdog interrupt on, steal priority 0, sub priority 0
    Instructions:
