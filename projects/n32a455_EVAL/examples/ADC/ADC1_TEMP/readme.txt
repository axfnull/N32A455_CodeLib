...
1. Function description
    1. ADC1 samples and converts the analog voltage of the internal temperature sensor and converts it into a temperature value
2. Use environment
...
3. Instructions for use
    System Configuration;
        ...
        3. ADC:
            ADC1 independent working mode, continuous conversion, software trigger, 12-bit data is right-aligned, conversion channel 16 is the analog voltage data of the internal temperature sensor
        4. Port configuration:
            PA9 is selected as the TX pin of USART1
            PA10 is selected as the RX pin of USART1
        5. USART:
            USART1 115200 baud rate, 8 data bits, 1 stop bit, no parity, no hardware flow control, transmit and receive enable
        6. Function function:
...
4. Matters needing attention
    ...
    When the system uses SI clock (generally HSE is turned off), RCC_ConfigAdc1mClk (RCC_ADC1MCLK_SRC_HSI, RCC_ADC1MCLK_DIV8) can only be configured as HSI