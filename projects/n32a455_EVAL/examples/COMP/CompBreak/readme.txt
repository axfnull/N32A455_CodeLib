...
3. Instructions for use
    ...
    Instructions:
        1. After compiling, open the debug mode, connect PE2 to PB10, connect PE3 to PA4, and use an oscilloscope or logic analyzer to observe the output waveforms of TIM1 and TIM8
