...
1. Function description
     1. The TIM3 CH2 capture pin calculates the duty cycle and frequency through the falling edge of CH1 and the rising edge of CH2
2. Use environment
...
3. Instructions for use
     System Configuration;
         1. Clock source:
                     HSE=8M,PLL=144M,AHB=144M,APB1=36M,APB2=72M,TIM3 CLK=72M
         2. Interrupt:
                     TIM3 CC2 compare interrupt on, steal priority 0, sub priority 0
     ...
     Instructions:
         ...
         2. After the program runs, the pulse data sent by PA0 can be captured to the period and frequency to the variable
