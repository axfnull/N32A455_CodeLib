...
1. Function description
    1. TIM2 uses CH1 CH2 CH3 CH4 CC value to generate timing interrupt and flip IO level
2. Use environment
...
3. Instructions for use
    System Configuration;
        ...
        4. TIM:
                    TIM2 output freeze mode, CH1 CH2 CH3 CH4 compare value generate interrupt
    Instructions:
        1. Open the debug mode after compiling, and use an oscilloscope or logic analyzer to observe the waveforms of PC6, PC7, PC8, and PC9
        2. After the program runs, after the corresponding channel reaches the comparison value, the comparison value is accumulated and the corresponding IO port level is flipped
