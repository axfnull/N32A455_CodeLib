...
1. Function description
     1. TIM1 and TIM8 output 3 channels of complementary waveforms and one channel of CH4 waveforms
2. Use environment
...
3. Instructions for use
     System Configuration;
         ...
         3. TIM:
                     TIM1 6-channel complementary output, CH4 output
                     TIM8 6-channel complementary output, CH4 output
     Instructions:
         1. Open the debug mode after compiling, and use an oscilloscope or logic analyzer to observe the output waveform of TIM1 and TIM8
         2. Output waveform TIM1 3-channel complementary plus one CH4, TIM8 3-channel complementary plus one CH4
