...
3. Instructions for use
    ...
    2. I2S is initialized to 16-bit data format, 48K sampling frequency. When there is data to receive, it enters the SPI3_IRQHandler function to receive data. When I2S2 has data to send, it enters the SPI2_IRQHandler function to send data. After the operation is completed, check that the status of TransferStatus1 is PASSED;
