...
1. Function description
    ...
    This test example demonstrates basic communication between USARTy and USARTz via DMA. USARTy and USARTz
Can be USART1 and USART2, USART3 and UART4, or UART6 and UART7.
    First, the DMA transfers the TxBuffer1 data to the USARTy transmit data register, and then the data is sent to
...
USARTy. USARTy receives data from DMA and stores it in RxBuffer1. Compare incoming and outgoing data, compare
