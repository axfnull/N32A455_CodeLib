...
1. Function description
    ...
    This test example demonstrates basic communication between USARTy and USARTz using hardware flow control. USARTy and
USARTz can be USART1 and USART2.
    First, USARTy uses CTS to send TxBuffer1 data, USARTz uses RTS to receive data, and save it to
RxBuffer2; USARTz uses CTS to send TxBuffer2 data, USARTy uses RTS to receive data, and save it to
RxBuffer1.
    Then, compare the received data with the sent data, and store the comparison results in TransferStatus1 and
...
3. Instructions for use
    ...
    - Reset operation, check the variables TransferStatus1 and TransferStatus2, where PASSED is the test passed,
      FAILED is a test exception
