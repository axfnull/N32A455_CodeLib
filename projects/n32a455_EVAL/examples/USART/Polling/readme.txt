...
Compare the received data with the sent data, and store the comparison result in the TransferStatus variable.
...
3. Instructions for use
    ...
    - Reset operation, check the variable TransferStatus twice, where PASSED is the test passed,
