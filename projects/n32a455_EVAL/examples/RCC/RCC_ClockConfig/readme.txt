...
3. Instructions for use
     ...
     /* Describe the test steps and phenomena of the Demo */
         ...
         2. Configure the system clock as HSI, HSE, PLL respectively, use the serial port to print out the current SYSCLK, HCLK, PCLK1, PCLK2 and other information, and use the PA8 multiplexing pin to output the clock, and view it with an oscilloscope;
